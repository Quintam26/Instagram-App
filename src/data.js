...
export const defaultUser = {
  ...
  name: "name",
  profile_image:
    "https://avatarfiles.alphacoders.com/205/thumb-205042.jpg"
  // profile_image:
...
export const defaultPost = {
  ...
  user: defaultUser,
  media:
    "https://images.unsplash.com/photo-1553675559-5046b59a5ca5?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=675&q=80",
  comments: [],
